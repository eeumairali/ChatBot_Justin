        ...
        {NEBULAS.map((n, i) => (
          <div
            ...
            style={{
              ...
              right:      (n as any).right  ?? undefined,
              top:        n.top   ?? undefined,
              bottom:     (n as any).bottom ?? undefined,
                ...
                >
                  ...
                  >
                    {message.sender === 'bot' ? (
                      ...
                      <p className="text-sm leading-relaxed whitespace-pre-wrap wrap-break-word text-white">{message.text}</p>
                    )}
                    <p
          ...
          <div className="max-w-6xl mx-auto">
            <form onSubmit={sendMessage} className="flex gap-3">
              <input
                ...
                className="flex-1 px-5 py-3 rounded-full text-white text-sm outline-none transition-all duration-300"
                style={{
